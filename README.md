...
Calculations for phonons are in part done by `phonopy`, program with a python API (though we do not use it--instead we use subprocesses to run phonopy in the shell). 
